      ...
      <div className="max-w-7xl mx-auto px-4 md:px-6 relative z-10">
        <div className="flex flex-col md:flex-row justify-between items-center">
          ...
          <motion.div 
            ...
            viewport={{ once: true }}
          >
            <a href="#" className="w-10 h-10 border-2 border-black bg-background hover:bg-primary transition-colors flex items-center justify-center mx-2">
              <svg 
            ...
            <a href="#" className="w-10 h-10 border-2 border-black bg-background hover:bg-secondary transition-colors flex items-center justify-center mx-2">
              <svg 
                xmlns="http://www.w3.org/2000/svg" 
                width="20" 
                height="20" 
            ...
            <a href="#" className="w-10 h-10 border-2 border-black bg-background hover:bg-accent transition-colors flex items-center justify-center mx-2">
              <svg 
                xmlns="http://www.w3.org/2000/svg" 
                width="20" 
                height="20" 
